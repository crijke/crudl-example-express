...
var createRouter = function() {
  ...
  router
    ...
    .get(function(req, res) {
      ...
      db.models.Section.count({}, function(err, count) {
        counter = count
      })
  ...
  router
    ...
    .get(function(req, res) {
      console.log('Searching for ' + req.params.id)
      db.models.Section.findById(req.params.id, 'name slug position', function(
        err,
        result
      ) {
        res.json(result)
  ...
  router
    ...
    .get(function(req, res) {
      ...
      db.models.Category.count({}, function(err, count) {
        counter = count
      })
  ...
  router
    ...
    .get(function(req, res) {
      ...
      db.models.Tag.count({}, function(err, count) {
        counter = count
      })
  ...
  router
    ...
    .get(function(req, res) {
      ...
      db.models.Entry.count({}, function(err, count) {
        counter = count
      })
  ...
  router
    ...
    .get(function(req, res) {
      ...
      db.models.EntryLink.count({}, function(err, count) {
        counter = count
      })
